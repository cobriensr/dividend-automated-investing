    ...
    def upload_file():
        ...
        if file:
            ...
            try:
                ...
                # For example, you might want to print the shape or head of the DataFrame
                print(f"DataFrame shape: {df.shape}")
                print(f"DataFrame head:\n{df.head()}")
                
                return jsonify({"message": f"File '{filename}' received and loaded successfully into a pandas DataFrame."})
